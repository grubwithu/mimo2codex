...
void i18n.use(initReactI18next).init({
  resources: {
    en: { common: enCommon, landing: enLanding, docs: enDocs, ideas: enIdeas },
    zh: { common: zhCommon, landing: zhLanding, docs: zhDocs, ideas: zhIdeas },
  },
  lng: "zh",
  fallbackLng: "en",
  defaultNS: "common",
  ns: ["common", "landing", "docs", "ideas"],
